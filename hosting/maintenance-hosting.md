...
Maintaining Drupal sites hosted on others servers is almost always inconvenient and consumes unnecessary time. This is because the development process would likely be on our servers while the live site remains on your current host. To have a great system for updating and working with changes, we prefer to have both the live and development sites on the same hosting platform. In some cases this is possible but is rarely cost effective.
